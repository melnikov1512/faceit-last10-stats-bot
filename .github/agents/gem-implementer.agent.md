...
## Constitutional
- **Language**: all code comments and any documentation produced (README updates, docstrings, JSDoc) must be written in English only, regardless of the chat language.
